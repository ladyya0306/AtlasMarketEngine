...
$src = Join-Path $root "results/run_20260323_060033"
$dst = Join-Path $root "results/night_plan/night_gate_20260322_210527/03_stability1_resume_m4_selected/R2A_s303_cont_m4"
